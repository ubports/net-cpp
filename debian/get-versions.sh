...
echo ${full_version} >${output_dir}/libnet-cpp.full-version
echo ${major} >${output_dir}/libnet-cpp.major-version
echo ${minor} >${output_dir}/libnet-cpp.minor-version
echo ${micro} >${output_dir}/libnet-cpp.micro-version
echo ${major_minor} >${output_dir}/libnet-cpp.major-minor-version
echo ${soversion} >${output_dir}/libnet-cpp.soversion
echo ${vivid_soversion} >${output_dir}/libnet-cpp.vivid-soversion
